...
protected:
  ...
  MPCDI_Error ReadDisplay1_0(tinyxml2::XMLElement *parent, Display & display);
  MPCDI_Error ReadBuffer1_0(tinyxml2::XMLElement *bufferElement, Display & buffer);
  MPCDI_Error ReadRegion(tinyxml2::XMLElement *regionElement, Buffer & buffer);
  MPCDI_Error ReadFrustum1_0(tinyxml2::XMLElement *frustumElement, Frustum & frustum);
  MPCDI_Error ReadCoordinateFrame1_0(tinyxml2::XMLElement *parent, CoordinateFrame &coordinateFrame);
  MPCDI_Error ReadFileSet1_0(std::string regionid, FileSet & fileSet);
  MPCDI_Error ReadAlphaMap1_0(tinyxml2::XMLElement *alphaMapElement, FileSet & fileSet);
  MPCDI_Error ReadBetaMap1_0(tinyxml2::XMLElement *betaMapElement, FileSet & fileSet);
  MPCDI_Error ReadGeometryWarpFile1_0(tinyxml2::XMLElement *gwfElement, FileSet & fileSet);
  MPCDI_Error ReadDistortionMapFile1_0(tinyxml2::XMLElement *dmfElement, FileSet & fileSet);
